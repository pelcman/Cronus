// モル (ルディブリアム チケット売場, wz script = sell_ticket) — オルビス行きチケット(4031045)の販売。
// 価格は OdinMS 系スクリプト値(6000メル、創作)、台詞は日本語化(創作)。
var TICKET = 4031045;
var PRICE = 6000;
function start() {
    if (player.haveItem(TICKET)) {
        cm.sendOk("#b#t" + TICKET + "##kはもうお持ちですね。乗船係の#bティティアン#kにお見せください。");
        return;
    }
    ...
    cm.sendOk("#b#t" + TICKET + "##kをどうぞ。乗船は#bティティアン#kへ。");
}
