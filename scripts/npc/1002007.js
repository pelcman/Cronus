// リス港口中型タクシー (リス港, wz script = taxi6) — ビクトリアアイランド6町へのタクシー(乗り場の町を除く)。
...
function start() {
    cm.sendNext("こんにちは～! リス港口中型タクシーです。他の村で安全で早く移動したいのですか? それなら私どものタクシーを利用してみて下さい。 安い価格でお望みの所まで親切に迎えて差し上げています。");
