// 母牛 1092091 (ノーチラスの牛小屋 912000100, JMS スクリプト名 mom_cow) — 空のミルクボトル(4031847)を 1/3(4031848) → 2/3(4031849) → 満タン(4031850) と満たしていく。
// 同じ牛から続けては搾れない(直前に搾った牛を 新鮮な牛乳を手に入れる(2180) の記録 "2" で覚える)。出典 Reference/Cosmic/scripts/npc/1092091.js。台詞は創作。
function start() {
    if (player.getQuestData(2180) == "2") {
