// ノーチラス大型タクシー (ノーチラス, wz script = taxi5) — ビクトリアアイランド6町へのタクシー(乗り場の町を除く)。
...
function start() {
    cm.sendNext("こんにちは！　ノーチラス大型タクシーでございます。他の村への安全で迅速な移動をお望みですか？でしたら我がタクシーをご利用ください。安い値段でお望みの場所まで親切にご案内しております。");
